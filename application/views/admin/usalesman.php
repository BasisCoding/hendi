  ...
  <div class="container-fluid mt--6">
          ...
          <div class="card">
            ...
            <div class="card-header">
                <div class="col text-right">
                    <button class="btn btn-sm btn-neutral btn-round btn-icon" data-toggle="modal" data-target="#modal-addSalesman">
            ...
            <div class="py-4">
              <table class="table table-flush" id="table-salesman">
      ...
      <div class="modal fade" id="modal-addSalesman" tabindex="-1" role="dialog" aria-labelledby="modal-addSalesman" aria-hidden="true">
        <div class="modal-dialog modal- modal-dialog-top modal-lg" role="document">
            <div class="modal-content">
                
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Tambah salesman</h6>
                ...
                <div class="modal-body">
                  <form class="form" id="form-addSalesman" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer mt-0">
                  <button type="submit" form="form-addSalesman" class="btn btn-primary align-right">Save</button>
                </div>
      ...
      <div class="modal fade" id="modal-updateSalesman" tabindex="-1" role="dialog" aria-labelledby="modal-updateSalesman" aria-hidden="true">
        <div class="modal-dialog modal- modal-dialog-top modal-lg" role="document">
            <div class="modal-content">
                
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Update salesman</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                  <form class="form" id="form-updateSalesman" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer mt-0">
                  <button type="submit" form="form-updateSalesman" class="btn btn-primary align-right">Save</button>
                </div>
      ...
      <div class="modal fade show" id="modal-deleteSalesman" tabindex="-1" role="dialog" aria-labelledby="modal-deleteSalesman" aria-modal="true">
          ...
          <div class="modal-content bg-gradient-danger">
            ...
            <div class="modal-body">
              <div class="py-3 text-center">
                ...
                <h4 class="heading mt-4">Apakah anda yakin ingin menghapus salesman <span id="salesman-delete"></span></h4>
                <form class="form" id="form-deleteSalesman" method="POST">
                  <input type="hidden" name="id_salesman_delete">
                </form>
              </div>
            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-white" id="btn-delete-salesman" form="form-deleteSalesman">Ok, Hapus</button>
