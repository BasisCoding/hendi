  ...
  <div class="container-fluid mt--6">
          ...
          <div class="card">
            ...
            <div class="card-header">
                <div class="col text-right">
                    <button class="btn btn-sm btn-neutral btn-round btn-icon" data-toggle="modal" data-target="#modal-addPengiriman">
            ...
            <div class="py-4">
              <table class="table table-flush" id="table-pengiriman">
                ...
                <tbody id="table-data-pengiriman">
                </tbody>
              </table>
            </div>
          </div>
      ...
      <div class="modal fade" id="modal-addPengiriman" tabindex="-1" role="dialog" aria-labelledby="modal-addpengiriman" aria-hidden="true">
        <div class="modal-dialog modal- modal-dialog-top modal-lg" role="document">
            <div class="modal-content">
                
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Tambah pengiriman</h6>
                ...
                <div class="modal-body">
                  <form class="form" id="form-addPengiriman" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer mt-0">
                  <button type="submit" form="form-addPengiriman" class="btn btn-primary align-right">Save</button>
                </div>
      ...
      <div class="modal fade" id="modal-updatePengiriman" tabindex="-1" role="dialog" aria-labelledby="modal-updatePengiriman" aria-hidden="true">
        <div class="modal-dialog modal- modal-dialog-top modal-lg" role="document">
            <div class="modal-content">
                
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-default">Update pengiriman</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                  <form class="form" id="form-updatePengiriman" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer mt-0">
                  <button type="submit" form="form-updatePengiriman" class="btn btn-primary align-right">Save</button>
                </div>
      ...
      <div class="modal fade show" id="modal-deletePengiriman" tabindex="-1" role="dialog" aria-labelledby="modal-deletePengiriman" aria-modal="true">
          ...
          <div class="modal-content bg-gradient-danger">
            ...
            <div class="modal-body">
              <div class="py-3 text-center">
                ...
                <h4 class="heading mt-4">Apakah anda yakin ingin menghapus pengiriman <span id="pengiriman-delete"></span></h4>
                <form class="form" id="form-deletePengiriman" method="POST">
                  <input type="hidden" name="id_pengiriman_delete">
                </form>
              </div>
            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-white" id="btn-delete-pengiriman" form="form-deletePengiriman">Ok, Hapus</button>
